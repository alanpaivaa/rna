...
from assignment0.dmc import DMC
...
dataset = Dataset('assignment0/datasets/iris.csv', encoding=iris_encodings[1])

# Artificial dataset
# dataset = Dataset('assignment0/datasets/artificial.csv')
